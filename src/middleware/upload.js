    ...
    if (err) {
      if (err instanceof multer.MulterError) {
        if (err.code === 'LIMIT_UNEXPECTED_FILE') {
          const allowedFields = ['storeImage', 'storeImage ', ' storeImage', 'storeImage[]', 'storeImage[] ', ' storeImage[]', 'panCardFront', 'panCardBack', 'aadharCardFront', 'aadharCardBack', 'drivingLicense', 'cancelCheque', 'companyLogo', 'companyLogo ', ' companyLogo', 'companyLogo[]', 'companyLogo[] ', ' companyLogo[]', 'profileImage', 'profileImage ', ' profileImage', 'profileImage[]', 'profileImage[] ', ' profileImage[]', 'image', 'image ', ' image', 'image[]', 'image[] ', ' image[]'];
